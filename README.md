About django-rest-hooks-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-rest-hooks-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3851&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-rest-hooks-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-rest-hooks` can be installed with `conda`:
...
```
mamba install django-rest-hooks
```

It is possible to list all of the versions of `django-rest-hooks` available on your platform with `conda`:
...
```
mamba search django-rest-hooks --channel conda-forge
```
...
mamba repoquery search django-rest-hooks --channel conda-forge

# List packages depending on `django-rest-hooks`:
mamba repoquery whoneeds django-rest-hooks --channel conda-forge

# List dependencies of `django-rest-hooks`:
mamba repoquery depends django-rest-hooks --channel conda-forge
```
